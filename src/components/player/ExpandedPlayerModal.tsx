  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 min-h-0 flex flex-col justify-between w-full max-w-5xl mx-auto py-1 sm:py-4">
        ...
        <div className="flex-1 min-h-0 flex flex-col items-center justify-center w-full py-4 sm:py-8">
          {isVideoMode ? (
              ...
              <div className="flex items-center justify-between gap-2 text-xs">
                {candidateVideoIds.length > 1 && (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 text-slate-200 font-bold inline-flex items-center gap-1.5 transition-colors"
                  >
                    <RefreshCw className="w-3.5 h-3.5 text-[#fa233b]" /> Alt Video ({videoIndex + 1}/{candidateVideoIds.length})
                  </button>
                )}
                <a
                  ...
                  className="px-3 py-1.5 rounded-xl bg-[#fa233b]/20 hover:bg-[#fa233b]/30 text-[#fa233b] font-extrabold border border-[#fa233b]/40 inline-flex items-center gap-1.5 transition-colors ml-auto"
                >
