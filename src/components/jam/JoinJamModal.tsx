  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="flex items-center justify-between pb-4 border-b border-white/10 relative z-10 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Bluetooth • Same Wi-Fi • Join Code</p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto py-4 space-y-6 relative z-10 custom-scrollbar pr-1">
          
          {/* 1. NEARBY JAMS SECTION (Bluetooth + Wi-Fi) */}
            ...
            {discoveredJams.length > 0 ? (
              ...
              <div className="p-4 rounded-2xl bg-white/[0.02] border border-dashed border-white/10 text-center space-y-2">
                ...
                <p className="text-[11px] text-zinc-500 leading-relaxed">
                  Make sure the host is nearby with Jam active, or join using their Join Code below.
                </p>
              </div>
            )}
          </div>
