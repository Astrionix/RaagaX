...
import { Home, Compass, Search, Library, Music, Settings, Tv } from 'lucide-react';
...
export function TVSidebar({ activeTab, setActiveTab, onOpenTVNowPlaying }: TVSidebarProps) {
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-4 px-4 py-3.5 rounded-2xl font-extrabold text-sm transition-all cursor-pointer ${
                isActive 
